#!/bin/bash
#
# ClaudeAgentsBar uninstaller — reverses what install.sh did:
#
...
#
# We leave ~/.claude/agent-state.tsv behind on purpose — you may want to
# inspect it; delete it manually if not.
...
echo "  ~/.claude/agent-state.tsv.lock"
