...
echo "  ~/.claude/agent-state.ai-titles.tsv"
echo "  ~/.claude/agent-state.idle-reminders"
echo "  ~/.claude/agent-state.blocked-reminders"
echo "  ~/.claude/agent-state.bookmarks"
echo "  ~/.claude/agent-state.tags"
echo "  ~/.claude/agent-state.ide-groups.mode"
echo "  ~/.claude/agent-state.multi-workspace.mode"
echo "  ~/.claude/agent-state.notify-audio.mode"
